...
def process_and_mail(pro_id, dept_name, exam_id, exam_name):
    ...
    print(f"✅ Downloaded {len(results)} student records. Generating HTML format...")
    html_report = cs.generate_html_report(results, exam_name, pro_id=pro_id, sess_id=sess_id)
