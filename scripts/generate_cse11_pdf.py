"""
generate_cse11_pdf.py
-----------------------
Generates a premium, uninterrupted PDF and HTML report of B.Sc. in CSE Batch 11
1st Year 1st Semester Examination of 2024 (Exam ID 1375) results.
Matches the CSE 08 layout and formatting exactly, with 100% correct data.
"""
...
EXAM_TITLE  = "B.Sc. in Computer Science and Engineering 1st Year 1st Semester Examination - 2024"
MAIN_SESS   = '24'   # regular batch session
...
def generate_html(results):
    ...
    # Scholarship / GPA ranking (only students who passed/promoted and have numeric GPA)
    valid_gpa = sorted(
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @page {
        size: 230mm 8500mm; /* Continuous scroll: massive height to prevent page breaks */
        margin: 0;
    }
    ...
    #cli-report-root .col-reg { width: 110px; text-align: center; }
    ...
    #cli-report-root .col-college { width: 220px; }
    ...
    """)
    parts.append(render_table(main_list,  "Registration-Wise Result (Regular Batch - Session 2023-24)"))
...
def main():
    results_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'found_results_cse11_exam1375.json')
    if not os.path.exists(results_file):
        print("ERROR: found_results_cse11_exam1375.json not found.")
        sys.exit(1)
    ...
    if not results:
        print("ERROR: found_results_cse11_exam1375.json is empty.")
        sys.exit(1)
...
<title>CSE 1st Year 1st Semester 2024 - All Colleges Result</title>
</head>
<body>
{html_content}
</body>
    ...
    html_path = os.path.join(base_dir, "cse_batch11_results_report.html")
    pdf_path  = os.path.join(base_dir, "cse_batch11_results_report.pdf")
    ...
    edge = find_edge()
    if not edge:
        print("Microsoft Edge not found. Please open cse_batch11_results_report.html manually and print to PDF.")
        return
    ...
    if os.path.exists(pdf_path) and os.path.getsize(pdf_path) > 1000:
        ...
        print("PDF generation may have failed. Check cse_batch11_results_report.html manually.")
